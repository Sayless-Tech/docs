---
title: Home
description: Sayless product guides covering workspace setup, inbox and ticket workflows, broadcasts, contacts, metrics, reports, and integrations.
mode: frame
---
...
<div data-product-guide-index className="flex w-full flex-col gap-8 max-w-5xl mx-auto px-4 md:px-8 lg:px-12 py-10 lg:gap-14 lg:py-16">
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <Card
      ...
      size={64}
    >
      <span className="product-guide-feature-card-description">Set up, configure, and manage your workspace.</span>
    </Card>
